...
import { C as stripBasePath, E as registerNavigationRuntimeFunctions, S as hasBasePath, T as hasAppNavigationRuntime, _ as createRouteTrieCache, a as isAbsoluteOrProtocolRelativeUrl, b as isDangerousScheme, c as toSameOriginAppPath, g as getLocalePathPrefix, h as getDomainLocaleUrl, i as isBotUserAgent, l as withBasePath, m as detectDomainLocale, n as __vitePreload, o as normalizePathTrailingSlash, p as addLocalePrefix, r as scheduleAppPrefetchFetch, s as toBrowserNavigationHref, t as usePathname, v as matchRouteWithTrie, w as getNavigationRuntime, x as reportBlockedDangerousNavigation } from "./index-3nqMU9F1.js";
		...
		(async () => {
			if (hasAppNavigationRuntime()) {
				...
				const [navigation, { AppElementsWire }, rscCacheBusting, { APP_RSC_RENDER_MODE_PREFETCH_DYNAMIC_SHELL, APP_RSC_RENDER_MODE_PREFETCH_LOADING_SHELL }, headersModule, hybridRouteOwner] = await Promise.all([
					__vitePreload(() => import("./index-3nqMU9F1.js"), __vite__mapDeps([0,1,2,3,4,5,6,7,8])),
...
async function promotePrefetchEntriesForNavigation(href) {
	...
	const [{ getPrefetchCache }, { stripRscCacheBustingSearchParam, stripRscSuffix }] = await Promise.all([__vitePreload(() => import("./index-3nqMU9F1.js"), __vite__mapDeps([0,1,2,3,4,5,6,7,8])), __vitePreload(() => import("./index-3nqMU9F1.js"), __vite__mapDeps([0,1,2,3,4,5,6,7,8]))]);
	let target;
	try {
	...
	const handleClick = async (e, options = {}) => {
		...
		if (hasAppNavigationRuntime) {
			const { navigateClientSide } = await __vitePreload(async () => {
				const { navigateClientSide } = await import("./index-3nqMU9F1.js");
